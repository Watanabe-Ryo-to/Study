...
class BillingServiceTest
{
	...
	{
		Invoice expected = new Invoice("INV-001", "C001", "田中商事", 100000, 10, 0, "2026-05-01", "2026-05-31", "未払い");
	...
	{
		Invoice invoice = new Invoice("INV-002", "C002", "鈴木物産", 50000, 10, 0, "2026-05-05", "2026-05-31", "未払い");
	...
	{
		Invoice invoice = new Invoice("INV-003", "C003", "佐藤工業", 100000, 10, 10000, "2026-05-06", "2026-05-31", "未払い");
	...
	{
		Invoice invoice = new Invoice("INV-004", "C001", "田中商事", 80000, 10, 0, "2026-05-10", "2026-05-31", "未払い");
	...
	{
		Invoice invoice = new Invoice("INV-006", "C004", "山田産業", 30000, 10, 0, "2026-05-12", "2026-05-31", "入金済");
	...
	{
		Invoice invoice = new Invoice("INV-007", "C005", "中村商会", 0, 10, 0, "2026-05-15", "2026-05-31", "未払い");
	...
	{
		Invoice invoice = new Invoice("INV-008", "C006", "加藤製作所", 50000, 120, 0, "2026-05-15", "2026-05-31", "未払い");
